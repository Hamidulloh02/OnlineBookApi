...
CORS_ORIGIN_WHITELIST = (
    'http://localhost:3000',
    'http://localhost:8000',
    'https://online-bookapi.up.railway.app'
)
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Assalomu alaykum xush kelibsiz",

    # Copyright on the footer
    "copyright": "Guliston va Teatr birlashgan tahririyati",
    ...
    "hide_apps": ['auth','auth token','sites','accounts'],
